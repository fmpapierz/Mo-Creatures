...
/**
 * Rat model, converted faithfully from the legacy {@code MoCModelRat} ({@code ModelBase}).
 * Geometry, texture offsets and the scurrying leg gait are preserved; only the scaffolding is modern.
 */
public class MoCModelRat extends EntityModel<MoCEntityRenderState> {

    private static final float DEG_TO_RAD = (float) (Math.PI / 180.0);
    private static final float PI_HALF = 1.570796F;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("body",
                ...
                PartPose.offsetAndRotation(0.0F, 19.0F, 0.0F, PI_HALF, 0.0F, 0.0F));
        root.addOrReplaceChild("tail",
                CubeListBuilder.create().texOffs(56, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F),
                PartPose.offsetAndRotation(0.0F, 19.0F, 5.0F, PI_HALF, 0.0F, 0.0F));
